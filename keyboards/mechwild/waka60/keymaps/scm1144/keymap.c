...
//Just adding a comment to test Github Desktop
 ...
 */
[LIGHT] = LAYOUT(
    RGB_M_P, RGB_M_B, _______, _______, _______, _______,          _______, _______, _______, _______,  RGB_TOG, _______,
    _______, _______, _______, _______, RED_CLR, _______,          YEL_CLR, _______, _______, _OOSSUU,  PUR_CLR, _______,
    _______, _______, _______, _______, _______, GRN_CLR,          _______, _______, _______, _______,  _______, LBL_CLR,
    ...
    const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
        ...
        [LOWER]   = { ENCODER_CCW_CW(KC_TRNS, KC_TRNS) },
        [RAISE]   = { ENCODER_CCW_CW(KC_TRNS, KC_TRNS) },
        [FUNCT]   = { ENCODER_CCW_CW(KC_PGDN, KC_PGUP) },
        [LIGHT]   = { ENCODER_CCW_CW(KC_BRID, KC_BRIU) },
    };
#endif
  ...
  switch (keycode) {
    ...
    case _OOSSUU:
      if (record->event.pressed) {
        rgblight_sethsv(14,255,34);
      }
      return false;
    case RED_CLR:
      if (record->event.pressed) {
        rgblight_sethsv(0,255,34);
      }
      return false;
    case GRN_CLR:
      if (record->event.pressed) {
        rgblight_sethsv(85,255,34);
      }
      return false;
    case BLU_CLR:
      if (record->event.pressed) {
        rgblight_sethsv(170,255,34);
      }
      return false;
    case LBL_CLR:
      if (record->event.pressed) {
        rgblight_sethsv(102,255,34);
      }
      return false;
    case YEL_CLR:
      if (record->event.pressed) {
        rgblight_sethsv(33,255,34);
      }
      return false;
    case PUR_CLR:
      if (record->event.pressed) {
        rgblight_sethsv(211,255,34);
      }
      return false;
